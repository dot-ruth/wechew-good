    ...
    <div className="min-h-screen bg-yellow-400/90 text-blue-900">
      ...
      <section id="episodes" className="container mx-auto py-12 px-4">
        ...
        <Card className="bg-yellow-300/90">
          <CardHeader>
            <CardTitle className="text-blue-900">እኔ የብዙ ውድቀቶች ስብስብ ነኝ |Brian Barani|ወቸው GOOD|</CardTitle>
            <CardDescription>Episode #130 • Mar 15, 2025</CardDescription>
          </CardHeader>
          <CardContent>
            <img
              src='https://img.youtube.com/vi/OqjjeRUNkPs/maxresdefault.jpg'
          ...
          <CardFooter>
            <Button className="bg-blue-700 text-yellow-400 hover:bg-blue-800">
            <Link href="https://www.youtube.com/watch?v=OqjjeRUNkPs" target='blank'>
              Listen Now
            </Link>
            </Button>
          </CardFooter>
