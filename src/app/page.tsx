    ...
    <div className="min-h-screen bg-yellow-400/90 text-blue-900">
      ...
      <section id="episodes" className="container mx-auto py-12 px-4">
        ...
        <Card className="bg-yellow-300/90">
          <CardHeader>
            <CardTitle className="text-blue-900">Social Media ላይ እንድወጣ ያደረገችኝ ሰላም ተስፋዬ ናት |Rosiye|ወቸው GOOD|</CardTitle>
            <CardDescription>Episode #126 • Feb 15, 2025</CardDescription>
          </CardHeader>
          <CardContent>
            <img
              src='https://img.youtube.com/vi/fr-3GncaTw4/maxresdefault.jpg'
          ...
          <CardFooter>
            <Button className="bg-blue-700 text-yellow-400 hover:bg-blue-800">
            <Link href="https://www.youtube.com/watch?v=fr-3GncaTw4" target='blank'>
              Listen Now
            </Link>
            </Button>
          </CardFooter>
